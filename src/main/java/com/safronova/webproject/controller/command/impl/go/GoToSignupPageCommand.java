...
public class GoToSignupPageCommand implements Command {
    ...
    private static final String REGEXP_USER_ADDRESS = properties.getProperty("regexp.address");
    ...
    public Router execute(HttpServletRequest request) {
        ...
        request.setAttribute(RequestAttribute.REGEXP_ADDRESS, REGEXP_USER_ADDRESS);
